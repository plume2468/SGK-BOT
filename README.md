...
已安装注册Telegram的用户（下同）可直接通过[**传送门**][https://t.me/aishegongkubot?start=AISGK_XBI9B5XC](url)访问，根据机器人提示操作即可。

## No. 1 （并列）: liemo （猎魔专用）
数据库数据达90%覆盖度。可通过每日签到、邀请或充值获得积分。首次查询请参考[使用教程](https://telegra.ph/Bot%E4%BD%BF%E7%94%A8%E6%95%99%E7%A8%8B-03-27)。

可直接通过[**传送门**][https://t.me/AJL01_bot?start=xOmKzBsScI](url)访问，根据机器人提示操作即可。
...
可直接通过[**传送门**][https://t.me/DingDangCats_Bot?start=b588b7b8e2be1db2](url)访问，根据机器人提示操作即可。
